...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('supplier_invoices', function (Blueprint $table) {
            if (!Schema::hasColumn('supplier_invoices', 'currency_id')) {
            ...
            if (!Schema::hasColumn('supplier_invoices', 'outstanding_amount')) {
                $table->decimal('outstanding_amount', 20, 4)->nullable()->after('total_amount');
            }
            if (!Schema::hasColumn('supplier_invoices', 'journal_id')) {
