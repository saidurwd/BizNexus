...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="#" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i> New Cost Center</a>
    </div>
@endsection
                            ...
                            @forelse($costCenters as $cc)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($cc->status === 'inactive')
                                            <span class="badge bg-secondary">Inactive</span>
                                        @else
                                            <span class="badge bg-warning text-dark">{{ $cc->status }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye"></i></a>
                                        <a href="#" class="btn btn-sm btn-outline-info"><i class="bi bi-pencil"></i></a>
