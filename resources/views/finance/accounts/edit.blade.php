                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="is_postable" name="is_postable">
                                ...
                                <option value="1" {{ old('is_postable', $account->is_postable) == 1 ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="revalue_foreign_currency" name="revalue_foreign_currency">
                                ...
                                <option value="1" @selected(old('revalue_foreign_currency', (int) $account->revalue_foreign_currency) == 1)>Yes (monetary item)</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="is_control_account" name="is_control_account">
                                ...
                                <option value="1" @selected(old('is_control_account', (int) $account->is_control_account) == 1)>Yes (sub-ledger postings only)</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="is_current" name="is_current">
                                <option value="">—</option>
                                <option value="1" @selected(old('is_current', $account->is_current) === '1' || old('is_current', $account->is_current) === true)>Current</option>
                                <option value="0" @selected(old('is_current', $account->is_current) === '0' || old('is_current', $account->is_current) === false)>Non-current</option>
                            </select>
                        </div>
                    </div>
                </div>
