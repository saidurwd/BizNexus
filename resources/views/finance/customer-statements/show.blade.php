...
@section('content_header')
    <h1>{{ __('Customer statement: :name', ['name' => $customer->name]) }}</h1>
    <div class="mt-2">
        <a href="{{ route('finance.customer-statements.index') }}" class="btn btn-secondary">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <strong>{{ __('Code:') }}</strong> {{ $customer->customer_code }}
                </div>
                <div class="col-md-3">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="table-active">
                            ...
                            <td class="text-end"><strong>{{ Formatter::amount(bcadd($statement['total_receipts'], $statement['total_credits'], 4)) }}</strong></td>
