...
<tr>
    <td>
        <select name="{{ $field('account_id') }}" class="form-select form-select-sm @if ($error('account_id')) is-invalid @endif" data-searchable required aria-label="{{ __('Account') }}">
    ...
    <td>
        <input type="text" name="{{ $field('description') }}" value="{{ $old('description') }}" class="form-control form-control-sm @if ($error('description')) is-invalid @endif" maxlength="255" required aria-label="{{ __('Description') }}">
    ...
    <td>
        <select name="{{ $field('tax_id') }}" class="form-select form-select-sm" aria-label="{{ __('Tax code') }}">
